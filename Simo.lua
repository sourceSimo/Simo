...
Simo_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Simo_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Simo_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Simo_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Simo_Msg = 'رب التفاعل✔️😍'  
end 
return Simo_Msg 
end
...
🔖↬Simo TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel Simo](t.me/simo) 

🔰↬[Information](t.me/simo)

👮‍♂️↬[DEVELOPER](t.me/simo)

👮‍♂️↬[DEVELOPER](t.me/to)

🔖↬[The way his inauguration](https://t.me/BOueuuehsgz)

📌↬[To talk to us](t.me/rrrrybiwt)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_,'['..Simo_Msg[math.random(#Simo_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيمو').." غادر" or text == 'غادر' then  
